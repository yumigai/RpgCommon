...
public class InfiniteScroll : UIBehaviour
{
	...
	public static int ListItemNum = -1;
	...
	protected override void Start ()
	{
		...
		//if(ListItemNum >= 0 && ListItemNum < instantateItemCount ){
			//instantateItemCount = ListItemNum;
		//}
		//ListItemNum = -1;
	...
	void Update()
	{
        if( itemList.First == null || itemList.Last == null){
            return;
        }
